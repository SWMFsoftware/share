...
public:
  ...
  //===================================================
  MDArray(long int n0, long int n1 = 0, long int n2 = 0, long int n3 = 0, long int n4 = 0){
    data = NULL;
    nDim = 0; 
    nSize_D = NULL; 
    nConvert_D = NULL; 
  ...
  MDArray(const MDArray<T> & in){
    ...
    if(this != &in ) {
      ...
      int size_D[nDimMax];
      for (int i=0; i<nDimMax; ++i) size_D[i] = 0; 
      nDim = in.get_nDim();
      for(int i = 0; i<nDim; ++i) size_D[i] = in.get_nSize(i);
      
      init(size_D[0],size_D[1],size_D[2],size_D[3],size_D[4]);
      
      // Deep copy.
      for(int i = 0; i<nTotal; ++i) data[i] = in.get_data(i);
    }
  }
  ...
  //===================================================
  void init(long int n0, long int n1 = 0, long int n2 = 0, long int n3 = 0, long int n4 = 0){
    clear();
    ...
    nSize_D[0] = n0; 
    if(n1 != 0) nSize_D[1] = n1;
    if(n2 != 0) nSize_D[2] = n2;
    if(n3 != 0) nSize_D[3] = n3;
    if(n4 != 0) nSize_D[4] = n4;
  ...
  //===================================================
  T operator()(long int i0, long int i1=-1, long int i2=-1, long int i3=-1,
               long int i4=-1) const {
#ifdef DEBUG     
    assert(i0<nSize_D[0]); 
    assert(i0>=0);
