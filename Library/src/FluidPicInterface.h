...
public:
                         ...
                         const Type z, const int is) const
  {
    ...
    int iMHD;
    iMHD = is;
    Jx = getFluidJx(iBlock, x, y, z, iMHD);
    return Jx;
  }
                         ...
                         const Type z, const int is) const
  {
    ...
    int iMHD;
    iMHD = is;
    Jy = getFluidJy(iBlock, x, y, z, iMHD);
    return Jy;
  }
  template <typename Type>
                         ...
                         const Type z, const int is) const
  {
    ...
    int iMHD;
    iMHD = is;
    Jz = getFluidJz(iBlock, x, y, z, iMHD);
    return Jz;
  }
  template <typename Type>
                           ...
                           const Type z, const int is) const
  {
    ...
    iMHD = is;
    Ppar =
        getFluidPpar(iBlock, x, y, z, iMHD);
    return Ppar;
  }
  template <typename Type>
